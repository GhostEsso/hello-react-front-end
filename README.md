...
This repo consumes API data from [Hello Rails Back-End](https://github.com/GhostEsso/hello-rails-back-end) project.
...
> cd my-folder
> git clone git@github.com:GhostEsso/hello-rails-back-end.git
